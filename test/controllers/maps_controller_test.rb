...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { adress: @map.adress, latitude: @map.latitude, longitude: @map.longitude }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { adress: @map.adress, latitude: @map.latitude, longitude: @map.longitude }
    assert_redirected_to map_path(assigns(:map))
  end
